...
export const developerProfile: DeveloperProfile = {
  ...
  tagline:
    "Lulusan Sarjana Teknik Informatika (S.Kom) IPK 3.81 | Spesialis Next.js, React, Node.js, Administrasi Server & IT Infrastructure.",
  bio: [
...
export const skillCategories: SkillCategory[] = [
  ...
  },
  {
    ...
    skills: [
      {
        name: "Administrasi VPS & Ubuntu Server",
        level: 90,
        iconName: "Cloud",
        color: "from-amber-500 to-orange-500",
      },
      {
        name: "Dukungan Jaringan (Cisco CCNA)",
        level: 85,
        iconName: "Box",
      ...
      {
        name: "SSH, Git & GitHub Workflows",
        level: 92,
        iconName: "GitBranch",
        color: "from-orange-500 to-red-500",
      },
      {
        name: "Figma UI/UX & Adobe Photoshop",
        level: 85,
        iconName: "Figma",
...
export const projectsData: Project[] = [
  {
    ...
    summary:
      "Sistem Informasi Tahapan dan Jangkauan Magang Akademik berbasis web untuk digitalisasi pendaftaran magang BBPOM Palembang.",
    description:
      "SITANJAK dikembangkan untuk BBPOM Palembang guna memodernisasi dan mendigitalisasi alur pendaftaran magang akademik. Memungkinkan proses administrasi menjadi transparan, terstruktur, dan mengurangi waktu verifikasi berkas secara signifikan.",
    tags: [
      "Next.js",
      "React.js",
      "Tailwind CSS",
  ...
  },
  {
    ...
    category: "Web App",
    summary:
      "Sistem Informasi Manajemen Data Internal BBPOM Palembang untuk digitalisasi indikator kinerja dan anggaran.",
    description:
      "Aplikasi web internal Metalika dirancang untuk mempermudah monitoring indikator kinerja instansi dan penyerapan anggaran secara terintegrasi, efisien, dan akurat.",
    tags: [
      "React.js",
      "Node.js",
      "Tailwind CSS",
  ...
  },
  {
    ...
    category: "Web App",
    summary:
      "Platform komunitas interaktif & responsif hasil pengembangan program Virtual Internship Maxy Academy.",
    description:
      "Trivian adalah platform komunitas web modern dengan desain responsif, antarmuka intuitif, dan komponen re-usable tinggi untuk interaksi antar anggota.",
  ...
  },
  {
    ...
    category: "Web App",
    summary:
      "Sistem pengaduan dan aspirasi masyarakat berbasis web hasil karya Maxy Academy 2nd Hackathon.",
    description:
      "Dikembangkan dalam kompetisi Hackathon dengan tenggat waktu terbatas, Lapor Pak memfasilitasi masyarakat untuk mengirimkan laporan publik dengan alur yang user-friendly.",
  ...
  },
  {
    ...
    category: "Web App",
    summary:
      "Solusi digital promosi pariwisata & UMKM Desa Lewunimalang, Bogor (Maxy National Hackathon).",
    description:
      "Platform web yang dirancang untuk memberdayakan ekonomi lokal Desa Lewunimalang melalui etalase produk UMKM dan direktori tempat wisata daerah.",
  ...
  },
  {
    ...
    category: "UI/UX",
    summary:
      "Perancangan UI/UX & Prototipe Sistem Informasi Perintis Dinas Komunikasi dan Informatika Kota Palembang.",
    description:
      "Desain antarmuka pengguna berbasis Figma untuk aplikasi layanan publik Perintis Kota Palembang selama masa Praktik Kerja Lapangan (PKL).",
...
export const testimonialsData: Testimonial[] = [
  {
    ...
    content:
      "Samsu memiliki inisiatif dan kemampuan teknis yang sangat baik. Aplikasi SITANJAK dan Metalika yang ia bangun sangat membantu digitalisasi proses administrasi dan monitoring internal BBPOM.",
    avatar: "/Pas Foto.jpeg",
    rating: 5,
  },
  {
    ...
    company: "Maxy Academy",
    content:
      "Etos kerja Samsu selama program Virtual Internship dan Hackathon sangat menonjol. Ia mampu menerjemahkan kebutuhan produk ke dalam UI React yang sangat responsif.",
    avatar: "/Foto 1.jpg",
    rating: 5,
  },
];
